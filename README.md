...
**NOTE:** This Module is not compatible with the next module since next.js uses a diffrent webpack setup
...
> cd my-app
> 
> npm run plguin p=https://github.com/dominikhaid/node-module-webpack.git
> 
> npm run dev